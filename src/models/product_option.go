...
type ProductOptionCategory struct {
	ID           snowflake.ID `gorm:"column:id;primarykey;type:bigint unsigned" json:"id,string"` // 主键
	ProductID    snowflake.ID `gorm:"column:product_id;index;not null;type:bigint unsigned" json:"product_id,string"`
...
type ProductOption struct {
	...
	CategoryID      snowflake.ID `gorm:"column:category_id;index;not null;type:bigint unsigned" json:"category_id,string"`
